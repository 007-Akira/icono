...
export default function HomePage() { return <><Hero /><BrandIntro /><SignatureServices /><FounderSection /><FeaturedTreatment /><GalleryPreview /><AppointmentEnquiry /><VisitIcono /></>; }
