...
export const metadata: Metadata = {
  ...
  title: { default: "Icono Beauty World & Makeover Studio | Salon in Kollam", template: "%s | Icono" },
  description: "Icono Beauty World & Makeover Studio in Karicode, Kollam offers professional hair, beauty, facial, bridal and makeover services. Enquire directly through WhatsApp.",
  openGraph: { title: "Icono Beauty World & Makeover Studio | Salon in Kollam", description: "Professional hair, beauty, facial, bridal and makeover services in Karicode, Kollam.", type: "website", locale: "en_IN" },
};
