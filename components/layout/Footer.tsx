...
export function Footer() {
  ...
  </div><div className="page-shell mt-14 flex flex-col gap-3 border-t border-floral/15 pt-6 text-xs text-bone sm:flex-row sm:items-center sm:justify-between"><p>© {new Date().getFullYear()} {business.name}. All rights reserved.</p><a href={`mailto:${business.email}`}>{business.email}</a></div></footer>;
}
