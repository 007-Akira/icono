...
export function FounderSection() {
  return (
    <section className="py-section">
      <div className="page-shell grid items-center gap-12 md:grid-cols-12">
        <div className="md:col-span-5 md:col-start-2">
          <SectionLabel>Founder</SectionLabel>
          <h2 className="display mt-5 text-5xl">{founder.name}</h2>
          <p className="eyebrow mt-7 text-olive">{founder.role}</p>
          <p className="mt-5 leading-7 text-olive">{founder.introduction}</p>
          <Link href="/about" className="eyebrow mt-8 inline-block border-b border-smoke pb-1">
            About the founder
          </Link>
        </div>
